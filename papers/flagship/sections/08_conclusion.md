...
as the first measured bound on that search. Two measurements would
extend the map from here: a recall-task learning-rate search for the
transformer baseline, and a tie from the geometric drift to a
behavioral cost.
