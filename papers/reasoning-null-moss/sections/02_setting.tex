...
(one-hop recovery must beat a shuffled-pairing null and an absolute 0.10
floor) and two alignment premises, (iii) query--key and (iv) key--value,
each requiring a same-entity median cosine above a shuffled-entity null's
95th percentile. Gate failure routes to probe-invalid, never to refutation.
...
verdicts routed mechanically (Appendix~\ref{app:gates} reproduces all
