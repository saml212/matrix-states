...
direction. Third, a targeted twelve-seed replication of that transient was
stopped by its own pre-registered batch-effect gate (cohort variance ratio
4.47 against a pinned cutoff of 4.0), % evidence: C7-replication
and the new cohort's interval spans zero. Each bound names the observation
that would overturn it. The complete program consumed approximately 9.5
