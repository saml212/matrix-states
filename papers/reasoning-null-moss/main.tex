...
fails the build rather than silently altering a panel. The archived raw
files, the figure script with its checksum manifest, the experiment
chains, and the full pre-registration text will be released with the
