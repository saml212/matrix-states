...
grow with context: recall stays at ceiling to eight times the binding span
at a constant 32{,}768 bytes, while no KV-cache budget up to thirty-two
times those bytes changes the baseline's chance-level reading. The
