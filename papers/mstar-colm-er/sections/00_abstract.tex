...
non-competitive at the matched budget; it stays at chance after a
separately pre-registered 27-cell search over transformer capacity (14M to
45M parameters, two to six layers), training length (20{,}000 and 60{,}000
steps), and learning rate. % <!-- evidence: C12 -->
State-zeroing localizes the recall
