...
non-competitive at the matched budget. Recall collapses to chance when
the first block's state is zeroed, while zeroing the second block's
leaves it unchanged. % <!-- evidence: C5 -->
