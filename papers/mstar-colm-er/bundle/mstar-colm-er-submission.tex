...
descriptively in Table~\ref{tab:capped}'s caption). Reference lines mark chance
...
$M \in \{2, \ldots, 32\}$ it reads 0.020 to
0.033. % <!-- evidence: C4 -->
...
recent tokens, does not either: no capped cell clears the bar, and no cap
moves the reading beyond chance-level noise in either direction
(Table~\ref{tab:capped}).
