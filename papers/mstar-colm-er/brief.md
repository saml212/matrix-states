...
| C7 | task2 (multi-hop): contender clears bar in 3/9 seeds (0.33447, 0.47949, 0.39087), ablation 0/9; pooled paired-Δ CI (−0.01999, 0.26782) marked NON-DECISION-GRADE (ablation var-ratio 6.14 > 4.0 batch-effect flag); adjudication: trainability/seed-variance confirmed, capability-boundary hypothesis rejected at this scale/budget, NOT a capability claim; seed-2 partial recall collapses to 0.010 at every extended horizon (`task2_sweep\|s2` in the horizon-refs file, all of H2/H4/H8 = 0.010009765625/0.010009765625/0.01025390625) | HTH §1.42 A3 (adjudication map pinned pre-launch) + `TASK2DIAG_VERDICT.json` + §1.41 (horizon collapse) | `2026-07-10_h2h_task2diag/results/TASK2DIAG_VERDICT.json` md5 66d2291d8e65932d368d8978bfd16bdc; the 0.010 horizon-collapse figure specifically traces to `2026-07-10_h2h_mstar/fanout/contender_horizon_refs.json` md5 afd5af6b68b8947fe6c4f12a827fd916 (same file as C3, seed-2 row) | Table 4 |
...
| C12 | Baseline-strengthening sweep (pre-registered HEAD_TO_HEAD §1.46, outcomes A/B/C fixed before launch; run 2026-09-02 on grace compute): transformer capacities C0 14,440,448 (2L/256/4h) / C1 16,014,336 (4L/256/4h) / C2 44,613,632 (6L/512/8h) × lr {1e-3, 3e-4} × steps {20k, 60k} × seeds 0–2, 27 cells (C2×3e-4×60k deferred by pre-registered trim; re-activation trigger did not fire); per-config mean acc_A 0.0283–0.0346 vs chance 0.03125 and bar 0.09375; n_clearing 0/3 in every config; best C2_lr1e-03_st20000 0.0346; final training loss 7.1–7.7 from 23.6 (contender 1.38 at matched budget); OUTCOME_A_NON_COMPETITIVE | `EXPERIMENT_LOG.md` 2026-09-02 #3; `experiment-runs/2026-09-03_recall_strengthen/STRENGTHEN_VERDICT.json` | `experiment-runs/2026-09-03_recall_strengthen/h2h_strengthen_*.json` (27 raws) + `remetric/*_round4.json` (27) + the reused C0k fix5 cells | §3 "Baseline strengthening" paragraph, abstract, limitations |
