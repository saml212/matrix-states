...
| C20 | K=69/seed=1730 exclusion disclosure: a thirteenth examined cell (earlier wave, identical failing signature) deliberately NOT flipped per the declared 11-cell recalibration scope; including it would shift the K=69 mean 0.9592 -> 0.9423, changing no conclusion | `KEY_ANCHORING_SCALING_DRAFT.md` ~5133 (disclosed scope decision + counterfactual shift) | `experiment-runs/2026-07-08_c17_repro/fits/recalibrated_admissibility_table.json` md5:0877b840cc928dae04dff1929c2a9692 (the NOT-flipped K69/s1730 row) | prose (§ frontier) |
