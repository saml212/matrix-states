...
\bottomrule
\end{tabular}
\caption{The causal razor on the zero-padded rank-$\dmin$ target (crosscheck
...
subspace lens, lands at $1.82/2.95/2.88/3.55/4.73$ against
$\dmin = 2/3/3/4/5$ with two ambient dimensions available, so the
recruited rank equals $\dmin$ without any restriction to the model's
dominant subspace.
% <!-- evidence: N15 -->
