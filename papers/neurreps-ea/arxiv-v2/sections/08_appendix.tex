...
$\pm$ sd over four seeds in every group. On the
...
(seed 0; $S_3$ mean $\pm$ sd over its four seeds), for completeness
alongside Table~\ref{tab:wmrank}. The capped cells sit at or below their
...
change the verdict. Own-bar clears: $S_4$ 4/4, $A_5$ 4/4, $S_5$ 2/4,
$A_6$ 4/4.}
% <!-- evidence: N16 -->
\label{tab:ext4seeds}
\end{table}
