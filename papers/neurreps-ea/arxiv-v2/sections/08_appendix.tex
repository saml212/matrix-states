...
$S_4$ and $S_5$'s razor $k{=}\dmin$ cells (Table~\ref{tab:razor}) numerically exceed their own unconstrained anchor by 0.10--0.15;
...
$S_4$ & 3 & 5 & $4.835 \pm 0.066$ ($n{=}5$) & 2.952 \\
$A_5$ & 3 & 5 & $4.781 \pm 0.066$ ($n{=}5$) & 2.882 \\
$S_5$ & 4 & 6 & $5.510 \pm 0.084$ ($n{=}3$) & 3.547 \\
$A_6$ & 5 & 7 & $6.717 \pm 0.022$ ($n{=}3$) & 4.730 \\
\bottomrule
\end{tabular}
...
causal wave's unconstrained arm against the rank-$\dmin$ target; $S_3$ is
a four-seed mean $\pm$ sd, the other four groups are single-seed. On the
zero-padded target the unconstrained state recruits $\dmin$
($1.82/2.95/2.88/3.55/4.73$ against $\dmin = 2/3/3/4/5$) and leaves the
