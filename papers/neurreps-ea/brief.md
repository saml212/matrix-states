...
1. **The causal razor (new; the headline).** Train-time force-rank at
   ...
   all 4 independent S3 seeds); recovery returns at k=d_min in 4/5 groups at n=4 seeds (S5 fails the pre-registered seed-mean rule, §1.36b; ≥0.9× the
...
| N16 | Razor at n=4 seeds (seeds 0–3) for S4/A5/S5/A6 (pre-registered §1.36b: seed-mean of k=d_min xrec90 vs the FIXED seed-0 bar; own-bar clears disclosed, not decisional): necessity k=d_min−1 xrec90 = 0.000 in all 16 new cells; S4 seed-mean 0.6875 ≥ 0.585 CONFIRMED (own-bar 4/4; per-seed k=d_min 0.800/0.600/0.700/0.650, anchors 0.650/0.500/0.700/0.650); A5 0.6500 ≥ 0.630 CONFIRMED (4/4; 0.700/0.750/0.600/0.550, anchors 0.700/0.700/0.550/0.550); A6 0.6750 ≥ 0.585 CONFIRMED (4/4; 0.650/0.650/0.850/0.550, anchors 0.650/0.600/0.850/0.500); S5 0.4125 < 0.450 FAILS at n=4 (own-bar 2/4; 0.600/0.250/0.350/0.450, anchors 0.500/0.400/0.250/0.550; clears the self-referential 0.3825 bar by +0.030, disclosed only). Self-referential bars 0.5625/0.5625/0.3825/0.5850; k=d_min+1 per seed S4 0.950/0.600/0.650/0.650, A5 0.750/0.750/0.550/0.450, S5 0.550/0.500/0.350/0.500, A6 0.700/0.700/0.800/0.550. Sufficiency claim narrows to 4/5 (S3, S4, A5, A6); N14 anchor-inversion holds in 3/4 S4 seeds and 2/4 S5 seeds (still unconfirmed) | `CAPABILITY_SEPARATION_DESIGN.md` §1.36b (pre-registration + HARVEST, 2026-09-03) | `experiment-runs/2026-09-03_m3fix_ext4/results/zero_pad__{S4,A5,S5,A6}__{unconstrained,k_dmin_minus_1,k_dmin,k_dmin_plus_1}__seed{1,2,3}.json` (48 files; md5s in `md5_manifest_local.txt`, 72/72 box match) + the seed-0 files `experiment-runs/2026-07-09_m3fix_harvest/zero_pad__{S4,A5,S5,A6}__*__seed0.json`; analysis output `harvest_analysis_output.txt`, `EXT4_VERDICT.json` | Table 1 (new seed-mean column) + Figure 1 caption + §5 text + Appendix `app:ext4causal` (`tab:ext4seeds`) + abstract/intro/Limitations wording |
