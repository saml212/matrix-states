...
In a full-attention model, ``hold $K$ items'' is satisfiable by
attending to $K$ raw-input positions at rank~1 each, so all information
...
projection), not post hoc; hypotheses, metrics, and decision bands were
