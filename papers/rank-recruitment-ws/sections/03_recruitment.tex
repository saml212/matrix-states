...
\textbf{Recruitment.} The observational half: without any rank term in
the loss, the trained $d{=}16$ state's effective rank rises one-for-one
...
% <!-- evidence: R1 -->
A 1{,}234-run replication is directionally identical.
% <!-- evidence: R1b -->
...
train-time force-rank $k$ (archived 991-run sweep; dashed line at
$k = K$). The step lands at $k \approx K$ in every cell.}
% <!-- evidence: R2 -->
\label{fig:forcerank}
\end{figure}

\textbf{Causal necessity.} The causal test trains with $Z$ constrained
to rank $k$ throughout (Figure~\ref{fig:forcerank}). At $d{=}8, K{=}4$
