...
is not guaranteed by the metric and is the paper's genuine causal
finding (sufficiency).
% <!-- evidence: U3 -->
...
Section~\ref{sec:causal} and Figure~\ref{fig:razor}, as decisional; no
conclusion in this paper reads the scale-only score. The two diverge
