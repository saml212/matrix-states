...
tie. The designed head-to-head is that tie: $S_4$ (solvable) and $A_5$
...
value). A pre-registered causal force-rank razor then confirms the
...
restoring $\dmin$ restores recovery. Learned
