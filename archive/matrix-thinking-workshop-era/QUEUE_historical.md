# Engineering Queue — Historical Body (matrix-CODI / workshop-paper era)

Archived 2026-07-04. This is the pre-2026-07-01 body of
`matrix-thinking/QUEUE.md`, split out to shrink the live file to its
current banner + pointer. Every item below is closed or superseded — see
`matrix-thinking/QUEUE.md`'s banner, or `STATE.md` "Chapter 2 — STATUS",
for where each item's successor work landed (Control A → `matrix-thinking/
CONTROL_A_HISTORY.md`; matrix-CODI rank dynamics → the accepted ICML MI
Workshop 2026 paper; Chapter 2 items → `matrix-thinking/chapter2/`).
