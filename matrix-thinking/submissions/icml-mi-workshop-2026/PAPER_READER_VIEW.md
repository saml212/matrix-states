...
2. **Three-seed accuracy–rank decoupling** (§3). Best ProsQA accuracy is $80.99 \pm 2.0$pp while the final effective rank of $Z$ spans $\{4, 12, 13\}$. The loss does not reward any particular rank.
...
> **Figure 2 (`figures/fig2_seed_decoupling.pdf`):** Three-seed replication of the flatten readout. Best ProsQA accuracy is $80.99 \pm 2.0$pp, but the final effective rank of $Z$ varies $3\times$ (seed 42 converges at rank ~4; seeds 1337 and 7 converge near rank 12). The loss does not push $Z$ toward any particular rank.
