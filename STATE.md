...
in a future, separately-costed wave. **Papers current as of this fold-in**
(iclr-2027 + workshop-2026 both updated with this verdict and §15.27's
pool-margin DEGENERATE_CELL escalation; see the "Last updated" line
above) — no further paper-fold-in queue item outstanding for either of
these two verdicts.
