...
CONFIG = {
    ...
    "max_eval_batches": 50,     # H100 NCCL timeout mitigation
    "eval_batch_size": 16,
...
def train_run(mode, cfg):
        ...
        if (epoch + 1) % cfg["eval_interval_epochs"] == 0:
            try:
                if is_main:
                    ...
                    logger.log(f"  GSM8K accuracy: {acc*100:.2f}%")
    ...
    if is_main:
        ...
        summary_lines = [
            ...
            "",
            f"  Best GSM8K accuracy: {best_acc*100:.2f}%",
            "=" * 70,
            "",
        ]
        summary = "\n".join(summary_lines)
