#!/usr/bin/env python3
"""
Exp F: Matrix Thinker d=16 — The 8× Speedup
=============================================
...
CONFIG = {
    ...
    "results_dir": "/toy_story_slam/results/exp_d16",
    "num_workers": 8,
}
...
class OptimizedMultiplicativeLayer(nn.Module):
    def __init__(self, d, r=4, dropout=0.1):
        super().__init__()
        self.norm = MatrixRMSNorm(d)
...
class ThinkingBlock(nn.Module):
    def __init__(self, d, n_heads=4, r=4, dropout=0.1):
        super().__init__()
...
class MatrixThinkerD16(nn.Module):
    def __init__(self, mat_dim=16, n_layers=8, n_heads=4, n_probes=16, r=4,
...
def run():
    ...
    logger.log(f"Exp F: Matrix Thinker d=16 | GPUs: {world_size}")
    ...
    if is_main:
        ...
        json.dump({"experiment": "exp_d16", "params": n_params,
