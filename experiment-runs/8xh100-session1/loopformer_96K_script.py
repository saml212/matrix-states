...
Usage:
  torchrun --standalone --nproc_per_node=8 run_loopformer_flops_matched.py
"""
...
CONFIG = {
    ...
    "results_dir": "/toy_story_slam/results/loopformer_flops_matched",
    "num_workers": 8,
}
...
def run():
    ...
    if is_main:
        ...
        json.dump({"experiment": "loopformer_flops_matched", "params": n_params,
