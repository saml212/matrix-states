...
CONFIG = {
    ...
    "n_iterations": 8, "max_len": 2048, "dropout": 0.1,
    "batch_size_per_gpu": 48, "seq_len": 512, "max_steps": 1000,
    "lr": 3e-4, "warmup_steps": 300, "weight_decay": 0.01, "grad_clip": 1.0,
    "eval_interval": 250, "eval_batch_size": 48, "eval_iterations": [1, 2, 4, 8],
    "log_interval": 50, "data_dir": "/toy_story_slam/data",
    "fallback_data_dir": "/toy_story_slam/data_quick",
    "results_dir": "/toy_story_slam/results/exp_3d_attn_full", "num_workers": 8,
}
...
def run():
    ...
    if is_main:
        ...
        json.dump({"experiment": "exp_3d_attn_full", "params": n_params,
