...
CONFIG = {
    ...
    # Paths
    "results_dir": "/workspace/pebble/round2_prosqa/results/matrix_codi",
    ...
    "prosqa_train_path": "/workspace/pebble/round2_prosqa/data/prosqa_train.json",
    "prosqa_val_path":   "/workspace/pebble/round2_prosqa/data/prosqa_test.json",
