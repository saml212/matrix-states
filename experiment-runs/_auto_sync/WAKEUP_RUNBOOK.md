...
for seed in 1337 42 7; do
  scp -i ~/.ssh/id_ed25519 -P 31954 root@38.80.152.148:/workspace/pebble/round4_sft_control/results/teacher_ce_seed${seed}/SUMMARY.txt \
...
scp -ri ~/.ssh/id_ed25519 -P 31954 root@38.80.152.148:/workspace/pebble/round5_sample_eff/results/ \
...
scp -ri ~/.ssh/id_ed25519 -P 31954 root@38.80.152.148:/workspace/pebble/round6_scale/results/ \
...
scp -ri ~/.ssh/id_ed25519 -P 31954 root@38.80.152.148:/workspace/pebble/round7_illusion/ \
...
```
ssh -i ~/.ssh/id_ed25519 -p 31954 root@38.80.152.148 'cat /workspace/pebble/queue.txt; echo ---; cat /workspace/pebble/master_state.json'
```
...
ssh -o ConnectTimeout=10 -i ~/.ssh/id_ed25519 -p 31954 root@38.80.152.148 '
